"""
CareerPath AI - Simple Working Version
====================================

Clean, error-free version with all core functionality.
"""
            ...
            if submitted:
                with st.spinner("🤖 AI is analyzing your profile..."):
                    try:
                        ...
                        # Model info
                        method = result.get('method', 'Random Forest')
    ...
    with tab3:
        ...
        with col2:
            ...
            if 'n_estimators' in model_info:
                ...
                st.metric("Estimators", n_estimators)
        
        # Model training section
        st.subheader("🔄 Model Retraining")
        
        if st.button("🚀 Retrain Model", help="Retrain the Random Forest model with the current dataset"):
