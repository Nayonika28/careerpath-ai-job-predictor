"""
CareerPath AI - Fixed Version
============================

Simplified, working version with all core functionality.
"""
...
def show_prediction_page():
            ...
            if submitted:
                with st.spinner("🤖 AI is analyzing your profile..."):
                    try:
                        ...
                        # Model info
                        st.info(f"🤖 Model Used: {result.get('method', 'Random Forest')}")
    ...
    with col2:
        ...
        # Model stats
        st.metric("Model Type", model_info.get('model_type', 'Random Forest'))
